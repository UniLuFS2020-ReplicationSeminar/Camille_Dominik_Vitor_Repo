...
#ESS<- na.omit(ESS)
VT<- glm(vote~depression + gndr + agea + eduyrs2 + income + health + rlgblg + married + union_ever + dispro_ess + gdppc_ess1000 + gini_ess1000 + unemploy + unemploy_ess1000 , ESS, family = binomial (logit))
summary(VT)
...
ESS<- na.omit(ESS)
VT2<- lm(motivation~depression + gndr + agea + eduyrs2 + income + health + rlgblg + married + union_ever + dispro_ess + gdppc_ess1000 + gini_ess1000 + unemploy + unemploy_ess1000 , ESS)
summary(VT2)
...
ESS<- na.omit(ESS)
VT3<- glm(phy_act~depression + gndr + agea + eduyrs2 + income + health + rlgblg + married + union_ever + dispro_ess + gdppc_ess1000 + gini_ess1000 + unemploy + unemploy_ess1000 , ESS, family=quasibinomial(link="logit"))
summary(VT3)
#Election is missing.
...
``` {r}
ESS<- na.omit(ESS)
VT4<- glm(nop_act~depression + gndr + agea + eduyrs2 + income + health + rlgblg + married + union_ever + dispro_ess + gdppc_ess1000 + gini_ess1000 + unemploy + unemploy_ess1000 , ESS, family=quasibinomial(link="logit"))
summary(VT4)
